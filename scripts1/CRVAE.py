########################################################################################################################
# File to reproduce the proposed method 'CRVAE' as mentioned in the paper.
########################################################################################################################
...
from models.CRmodel import SECRVAE
import pickle
import numpy as np
...
with tf.Session(config=SESS_CONF).as_default() as sess:
    ...
    for noise_type in noise_types:
        for test_file in test_files:
            ...
            Cttfeats = np.reshape(Nttfeats, (-1, SEQ_LEN, 200))
